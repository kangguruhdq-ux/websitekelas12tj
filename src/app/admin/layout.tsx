  ...
  return (
    <div className="min-h-screen bg-[#161512] text-[#d8d6c6] flex flex-col md:flex-row">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 sm:h-20 px-4 sm:px-6 bg-[#161512]/90 backdrop-blur-md border-b border-[#f5f1ca]/10 flex items-center justify-between sticky top-0 z-30">
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="md:hidden p-2 rounded-xl text-[#d8d6c6] hover:bg-[#f5f1ca]/10 hover:text-[#f2eb87]"
            >
        ...
        <main className="p-4 sm:p-6 lg:p-8 flex-1 overflow-x-hidden min-h-[calc(100vh-5rem)]">
      ...
      {mobileSidebarOpen && (
        <div className="fixed inset-0 z-50 md:hidden flex">
          ...
          />
          <div className="relative w-64 max-w-[80vw] bg-[#141310] h-full z-10 flex flex-col border-r border-[#f5f1ca]/10">
